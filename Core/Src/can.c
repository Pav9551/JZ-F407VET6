...
void MX_CAN1_Init(void)
{
  ...
  /* CAN filter configuration */
      ...
      if (HAL_CAN_ActivateNotification(&hcan1, CAN_IT_RX_FIFO1_MSG_PENDING | CAN_IT_ERROR | CAN_IT_BUSOFF | CAN_IT_LAST_ERROR_CODE ) != HAL_OK)
            {
                // Notification Error
                Error_Handler();
            }
...
void MX_CAN2_Init(void)
{
  ...
  /* CAN filter configuration for CAN2 */
      ...
      if (HAL_CAN_ActivateNotification(&hcan2, CAN_IT_RX_FIFO0_MSG_PENDING | CAN_IT_ERROR | CAN_IT_BUSOFF | CAN_IT_LAST_ERROR_CODE ) != HAL_OK)
                  {
                      // Notification Error
                      Error_Handler();
...
/* USER CODE BEGIN 1 */
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef *hcan)//can2
{
